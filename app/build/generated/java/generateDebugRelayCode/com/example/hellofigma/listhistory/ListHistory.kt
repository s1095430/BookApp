package com.example.hellofigma.listhistory
...
/**
 * This composable was generated from the UI Package 'list_history'.
 * Generated code; do not edit directly
 */
@Composable
fun ListHistory(modifier: Modifier = Modifier) {
...
@Composable
private fun ListHistoryPreview() {
    MaterialTheme {
        RelayContainer {
            ListHistory(modifier = Modifier.rowWeight(1.0f).columnWeight(1.0f))
        }
    }
}
...
fun Background3(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.list_history_background3),
        modifier = modifier.requiredWidth(430.0.dp).requiredHeight(185.0.dp)
    )
}

@Composable
fun PIC3(modifier: Modifier = Modifier) {
    RelayImage(
        image = painterResource(R.drawable.list_history_pic3),
...
@Composable
fun Seller3(modifier: Modifier = Modifier) {
    RelayText(
        content = "賣家：xxx",
        fontSize = 20.0.sp,
        height = 1.171875.em,
...
@Composable
fun Time3(modifier: Modifier = Modifier) {
    RelayText(
...
@Composable
fun Number3(modifier: Modifier = Modifier) {
    RelayText(
...
fun Background2(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.list_history_background2),
        modifier = modifier.requiredWidth(430.0.dp).requiredHeight(185.0.dp)
    )
}
...
fun Rectangle8(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.list_history_rectangle_8),
        modifier = modifier.requiredWidth(69.0.dp).requiredHeight(186.0.dp)
    )
}

@Composable
fun Done1(modifier: Modifier = Modifier) {
    RelayText(
        content = "完成",
        fontSize = 30.0.sp,
        height = 1.171875.em,
        textAlign = TextAlign.Left,
        maxLines = -1,
        modifier = modifier.requiredWidth(61.5405387878418.dp).requiredHeight(49.0.dp)
    )
}
...
fun OderRescords2(
    ...
    RelayContainer(
        ...
        clipToParent = false,
        content = content,
        modifier = modifier.requiredWidth(499.0.dp).requiredHeight(186.0.dp)
    )
}
...
fun Background1(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.list_history_background1),
        modifier = modifier.requiredWidth(506.0.dp).requiredHeight(185.0.dp)
    )
}
...
fun Rectangle9(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.list_history_rectangle_9),
        modifier = modifier.requiredWidth(74.0.dp).requiredHeight(186.0.dp)
    )
}

@Composable
fun Cancel1(modifier: Modifier = Modifier) {
    RelayText(
        content = "取消",
        fontSize = 30.0.sp,
        height = 1.171875.em,
        textAlign = TextAlign.Left,
        maxLines = -1,
        modifier = modifier.requiredWidth(66.0.dp).requiredHeight(49.0.dp)
    )
}
...
fun OderRescords1(
    ...
    RelayContainer(
        ...
        clipToParent = false,
        content = content,
        modifier = modifier.requiredWidth(506.0.dp).requiredHeight(186.0.dp)
    )
}
...
fun BackgroundSE(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.list_history_background_se),
...
fun Seleated(
    ...
    RelayContainer(
        ...
        content = content,
        modifier = modifier.requiredWidth(153.0.dp).requiredHeight(55.0.dp)
    )
}
...
fun Switch(
    ...
    RelayContainer(
        ...
        radius = 33.943031311035156,
        content = content,
        modifier = modifier.requiredWidth(330.0.dp).requiredHeight(55.0.dp)
    )
}

@Composable
fun ListHistory5(modifier: Modifier = Modifier) {
    RelayText(
        content = "訂單紀錄",
...
fun Background(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.list_history_background),
...
fun Logo(modifier: Modifier = Modifier) {
    RelayImage(
        image = painterResource(R.drawable.list_history_logo),
        contentScale = ContentScale.Crop,
...
fun Input(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.list_history_input),
...
fun Vector(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.list_history_vector),
...
fun Vector2(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.list_history_vector_2),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
...
fun Ellipse1(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.list_history_ellipse_1),
        modifier = modifier.padding(
            paddingValues = PaddingValues(
...
fun Line22(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.list_history_line_22),
...
fun Line24(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.list_history_line_24),
        modifier = modifier.requiredWidth(32.0.dp).requiredHeight(0.0.dp)
    )
}
...
fun Line23(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.list_history_line_23),
        modifier = modifier.requiredWidth(32.0.dp).requiredHeight(0.0.dp)
    )
}
