...
@Composable
fun Fail(modifier: Modifier = Modifier) {
    RelayImage(
        image = painterResource(R.drawable.do_fail_fail),
        radius = 80.01219177246094,
        contentScale = ContentScale.FillBounds,
        modifier = modifier.requiredWidth(143.04054260253906.dp).requiredHeight(145.0.dp)
    )
}
