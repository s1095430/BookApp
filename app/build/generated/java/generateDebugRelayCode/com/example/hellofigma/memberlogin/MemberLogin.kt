package com.example.hellofigma.memberlogin
 ...
 * login
 *
 * This composable was generated from the UI Package 'member_login'.
 * Generated code; do not edit directly
 */
@Composable
fun MemberLogin(modifier: Modifier = Modifier) {
...
@Composable
private fun MemberLoginPreview() {
    MaterialTheme {
        RelayContainer {
            MemberLogin(modifier = Modifier.rowWeight(1.0f).columnWeight(1.0f))
        }
    }
}
...
fun Image3(modifier: Modifier = Modifier) {
    RelayImage(
        image = painterResource(R.drawable.member_login_image_3),
...
fun Background(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.member_login_background),
...
fun Rectangle8(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.member_login_rectangle_8),
...
fun ForgetPassword(modifier: Modifier = Modifier) {
    RelayText(
        ...
        height = 1.210227280483196.em,
        modifier = modifier
    )
}

@Composable
fun NewAccont(modifier: Modifier = Modifier) {
    RelayText(
        content = "註冊新帳號",
        fontSize = 20.9592227935791.sp,
        fontFamily = inter,
...
fun Rectangle4(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.member_login_rectangle_4),
...
fun Rectangle3(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.member_login_rectangle_3),
        modifier = modifier.requiredWidth(260.0.dp).requiredHeight(50.0.dp)
    )
}
...
fun Ellipse1(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.member_login_ellipse_1),
